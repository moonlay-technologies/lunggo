...
var ResetPasswordConfig = {
    Url: 'https://api.local.travorama.com/v1/account/resetpassword'
};
...
var ResendConfirmationEmailConfig = {
    Url: 'https://api.local.travorama.com/v1/account/resendconfirmationemail'
};
...
var TransferConfig = {
    Url: 'https://api.local.travorama.com/v1/payment/transferfee'
};
...
var ResetPasswordMobileConfig = {
    Url: 'http://m.local.travorama.com/v1/account/resetpassword'
};
...
var ResendConfirmationEmailMobileConfig = {
    Url: 'http://m.local.travorama.com/v1/account/resendconfirmationemail'
};
