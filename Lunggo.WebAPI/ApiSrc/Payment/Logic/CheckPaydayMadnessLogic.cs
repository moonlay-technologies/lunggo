...
namespace Lunggo.WebAPI.ApiSrc.Payment.Logic
{
    ...
    {
        public static ApiResponseBase CheckPaydayMadness(CheckPaydayMadnessApiRequest request)
        {
            ...
            var binDiscount = CampaignService.GetInstance().CheckPaydayMadness(request.RsvNo, request.VoucherCode);
