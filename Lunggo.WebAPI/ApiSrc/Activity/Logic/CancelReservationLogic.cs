...
namespace Lunggo.WebAPI.ApiSrc.Activity.Logic
{
    ...
    {
        public static ApiResponseBase CancelReservation(string rsvNo, ApplicationUserManager userManager)
        {
            ...
            var serviceResponse = ActivityService.GetInstance().CancelAppointmentByCustomer(serviceRequest);
