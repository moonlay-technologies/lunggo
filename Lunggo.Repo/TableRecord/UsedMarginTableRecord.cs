...
{
    public class UsedMarginTableRecord : Lunggo.Framework.Database.TableRecord
    {
		...
		public static UsedMarginTableRecord CreateNewInstance()
        {
            var record = new UsedMarginTableRecord();
            var iRecord = record.AsInterface();
            iRecord.ManuallyCreated = true;
            return record;
        }

		public UsedMarginTableRecord()
        {
            ;
        }

        static UsedMarginTableRecord()
        {
            InitTableName();
            InitRecordMetadata();
