...
{
    public class ActivityPayRulesOperatorTableRecord : Lunggo.Framework.Database.TableRecord
    {
		...
		public static ActivityPayRulesOperatorTableRecord CreateNewInstance()
        {
            var record = new ActivityPayRulesOperatorTableRecord();
            var iRecord = record.AsInterface();
            iRecord.ManuallyCreated = true;
            return record;
        }

		public ActivityPayRulesOperatorTableRecord()
        {
            ;
        }

        static ActivityPayRulesOperatorTableRecord()
        {
            InitTableName();
            InitRecordMetadata();
        ...
        {
            _tableName = "ActivityPayRulesOperator";
        }
        ...
        private static void InitRecordMetadata()
        {
            _recordMetadata = new List<ColumnMetadata>
            {
				...
				new ColumnMetadata("IsCash", false),
