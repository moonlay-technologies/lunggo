...
{
    public class RefundRulesOperatorTableRecord : Lunggo.Framework.Database.TableRecord
    {
		...
		public static RefundRulesOperatorTableRecord CreateNewInstance()
        {
            var record = new RefundRulesOperatorTableRecord();
            var iRecord = record.AsInterface();
            iRecord.ManuallyCreated = true;
            return record;
        }

		public RefundRulesOperatorTableRecord()
        {
            ;
        }

        static RefundRulesOperatorTableRecord()
        {
            InitTableName();
            InitRecordMetadata();
        ...
        {
            _tableName = "RefundRulesOperator";
        }
