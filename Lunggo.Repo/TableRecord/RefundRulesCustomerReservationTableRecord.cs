...
{
    public class RefundRulesCustomerReservationTableRecord : Lunggo.Framework.Database.TableRecord
    {
		...
		public static RefundRulesCustomerReservationTableRecord CreateNewInstance()
        {
            var record = new RefundRulesCustomerReservationTableRecord();
            var iRecord = record.AsInterface();
            iRecord.ManuallyCreated = true;
            return record;
        }

		public RefundRulesCustomerReservationTableRecord()
        {
            ;
        }

        static RefundRulesCustomerReservationTableRecord()
        {
            InitTableName();
            InitRecordMetadata();
        ...
        {
            _tableName = "RefundRulesCustomerReservation";
        }
