...
namespace Lunggo.Repository.TableRepository
{
	public class FlightCrawlTargetTableRepo : TableDao<FlightCrawlTargetTableRecord>, IDbTableRepository<FlightCrawlTargetTableRecord> 
    {
		...
		public FlightCrawlTargetTableRecord Find1(IDbConnection connection, FlightCrawlTargetTableRecord record)
        {
            return Find1(connection, record, CommandDefinition.GetDefaultDefinition());
        }

		public IEnumerable<FlightCrawlTargetTableRecord> Find(IDbConnection connection, FlightCrawlTargetTableRecord record)
        {
		...
		public FlightCrawlTargetTableRecord Find1(IDbConnection connection, FlightCrawlTargetTableRecord record, CommandDefinition definition)
        {
			return Find1Internal(connection, record, definition);
        }

		public IEnumerable<FlightCrawlTargetTableRecord> Find(IDbConnection connection, FlightCrawlTargetTableRecord record, CommandDefinition definition)
        {
