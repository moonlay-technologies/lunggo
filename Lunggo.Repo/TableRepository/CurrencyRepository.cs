...
namespace Lunggo.Repository.TableRepository
{
	public class CurrencyTableRepo : TableDao<CurrencyTableRecord>, IDbTableRepository<CurrencyTableRecord> 
    {
		...
		public CurrencyTableRecord Find1(IDbConnection connection, CurrencyTableRecord record)
        {
            return Find1(connection, record, CommandDefinition.GetDefaultDefinition());
        }

		public IEnumerable<CurrencyTableRecord> Find(IDbConnection connection, CurrencyTableRecord record)
        {
		...
		public CurrencyTableRecord Find1(IDbConnection connection, CurrencyTableRecord record, CommandDefinition definition)
        {
			return Find1Internal(connection, record, definition);
        }

		public IEnumerable<CurrencyTableRecord> Find(IDbConnection connection, CurrencyTableRecord record, CommandDefinition definition)
        {
