...
namespace Lunggo.Repository.TableRepository
{
	public class UserLoginTableRepo : TableDao<UserLoginTableRecord>, IDbTableRepository<UserLoginTableRecord> 
    {
		...
		public UserLoginTableRecord Find1(IDbConnection connection, UserLoginTableRecord record)
        {
            return Find1(connection, record, CommandDefinition.GetDefaultDefinition());
        }

		public IEnumerable<UserLoginTableRecord> Find(IDbConnection connection, UserLoginTableRecord record)
        {
		...
		public UserLoginTableRecord Find1(IDbConnection connection, UserLoginTableRecord record, CommandDefinition definition)
        {
			return Find1Internal(connection, record, definition);
        }

		public IEnumerable<UserLoginTableRecord> Find(IDbConnection connection, UserLoginTableRecord record, CommandDefinition definition)
        {
