...
namespace Lunggo.Repository.TableRepository
{
	public class SavedCreditCardTableRepo : TableDao<SavedCreditCardTableRecord>, IDbTableRepository<SavedCreditCardTableRecord> 
    {
		...
		public static SavedCreditCardTableRepo GetInstance()
        {
            return Instance;
        }

        public int Insert(IDbConnection connection, SavedCreditCardTableRecord record)
        {
            return Insert(connection, record, CommandDefinition.GetDefaultDefinition());
        }

        public int Delete(IDbConnection connection, SavedCreditCardTableRecord record)
        {
            return Delete(connection, record, CommandDefinition.GetDefaultDefinition());
        }

		public int Update(IDbConnection connection, SavedCreditCardTableRecord record)
        {
        ...
        public int Insert(IDbConnection connection, SavedCreditCardTableRecord record, CommandDefinition definition)
        {
            return InsertInternal(connection, record, definition);
        }

        public int Delete(IDbConnection connection, SavedCreditCardTableRecord record, CommandDefinition definition)
        {
        ...
        public IEnumerable<SavedCreditCardTableRecord> FindAll(IDbConnection connection, CommandDefinition definition)
        {
