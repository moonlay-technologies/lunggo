...
namespace Lunggo.Repository.TableRepository
{
	public class RefreshTokenTableRepo : TableDao<RefreshTokenTableRecord>, IDbTableRepository<RefreshTokenTableRecord> 
    {
		...
		public RefreshTokenTableRecord Find1(IDbConnection connection, RefreshTokenTableRecord record)
        {
            return Find1(connection, record, CommandDefinition.GetDefaultDefinition());
        }

		public IEnumerable<RefreshTokenTableRecord> Find(IDbConnection connection, RefreshTokenTableRecord record)
        {
		...
		public RefreshTokenTableRecord Find1(IDbConnection connection, RefreshTokenTableRecord record, CommandDefinition definition)
        {
			return Find1Internal(connection, record, definition);
        }

		public IEnumerable<RefreshTokenTableRecord> Find(IDbConnection connection, RefreshTokenTableRecord record, CommandDefinition definition)
        {
