...
namespace Lunggo.Repository.TableRepository
{
	public class UserTableRepo : TableDao<UserTableRecord>, IDbTableRepository<UserTableRecord> 
    {
		...
		public UserTableRecord Find1(IDbConnection connection, UserTableRecord record)
        {
            return Find1(connection, record, CommandDefinition.GetDefaultDefinition());
        }

		public IEnumerable<UserTableRecord> Find(IDbConnection connection, UserTableRecord record)
        {
		...
		public UserTableRecord Find1(IDbConnection connection, UserTableRecord record, CommandDefinition definition)
        {
			return Find1Internal(connection, record, definition);
        }

		public IEnumerable<UserTableRecord> Find(IDbConnection connection, UserTableRecord record, CommandDefinition definition)
        {
