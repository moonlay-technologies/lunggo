...
namespace Lunggo.Repository.TableRepository
{
	public class PriceTableRepo : TableDao<PriceTableRecord>, IDbTableRepository<PriceTableRecord> 
    {
		...
		public PriceTableRecord Find1(IDbConnection connection, PriceTableRecord record)
        {
            return Find1(connection, record, CommandDefinition.GetDefaultDefinition());
        }

		public IEnumerable<PriceTableRecord> Find(IDbConnection connection, PriceTableRecord record)
        {
		...
		public PriceTableRecord Find1(IDbConnection connection, PriceTableRecord record, CommandDefinition definition)
        {
			return Find1Internal(connection, record, definition);
        }

		public IEnumerable<PriceTableRecord> Find(IDbConnection connection, PriceTableRecord record, CommandDefinition definition)
        {
