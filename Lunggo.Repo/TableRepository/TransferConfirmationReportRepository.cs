...
namespace Lunggo.Repository.TableRepository
{
	public class TransferConfirmationReportTableRepo : TableDao<TransferConfirmationReportTableRecord>, IDbTableRepository<TransferConfirmationReportTableRecord> 
    {
		...
		public TransferConfirmationReportTableRecord Find1(IDbConnection connection, TransferConfirmationReportTableRecord record)
        {
            return Find1(connection, record, CommandDefinition.GetDefaultDefinition());
        }

		public IEnumerable<TransferConfirmationReportTableRecord> Find(IDbConnection connection, TransferConfirmationReportTableRecord record)
        {
		...
		public TransferConfirmationReportTableRecord Find1(IDbConnection connection, TransferConfirmationReportTableRecord record, CommandDefinition definition)
        {
			return Find1Internal(connection, record, definition);
        }

		public IEnumerable<TransferConfirmationReportTableRecord> Find(IDbConnection connection, TransferConfirmationReportTableRecord record, CommandDefinition definition)
        {
