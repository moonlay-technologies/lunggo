...
namespace Lunggo.Repository.TableRepository
{
	public class UsedMarginTableRepo : TableDao<UsedMarginTableRecord>, IDbTableRepository<UsedMarginTableRecord> 
    {
		...
		public UsedMarginTableRecord Find1(IDbConnection connection, UsedMarginTableRecord record)
        {
            return Find1(connection, record, CommandDefinition.GetDefaultDefinition());
        }

		public IEnumerable<UsedMarginTableRecord> Find(IDbConnection connection, UsedMarginTableRecord record)
        {
		...
		public UsedMarginTableRecord Find1(IDbConnection connection, UsedMarginTableRecord record, CommandDefinition definition)
        {
			return Find1Internal(connection, record, definition);
        }

		public IEnumerable<UsedMarginTableRecord> Find(IDbConnection connection, UsedMarginTableRecord record, CommandDefinition definition)
        {
