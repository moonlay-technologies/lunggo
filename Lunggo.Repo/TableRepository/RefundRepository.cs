...
namespace Lunggo.Repository.TableRepository
{
	public class RefundTableRepo : TableDao<RefundTableRecord>, IDbTableRepository<RefundTableRecord> 
    {
		...
		public RefundTableRecord Find1(IDbConnection connection, RefundTableRecord record)
        {
            return Find1(connection, record, CommandDefinition.GetDefaultDefinition());
        }

		public IEnumerable<RefundTableRecord> Find(IDbConnection connection, RefundTableRecord record)
        {
		...
		public RefundTableRecord Find1(IDbConnection connection, RefundTableRecord record, CommandDefinition definition)
        {
			return Find1Internal(connection, record, definition);
        }

		public IEnumerable<RefundTableRecord> Find(IDbConnection connection, RefundTableRecord record, CommandDefinition definition)
        {
