...
namespace Lunggo.Repository.TableRepository
{
	public class UsdExchangeRateTableRepo : TableDao<UsdExchangeRateTableRecord>, IDbTableRepository<UsdExchangeRateTableRecord> 
    {
		...
		public UsdExchangeRateTableRecord Find1(IDbConnection connection, UsdExchangeRateTableRecord record)
        {
            return Find1(connection, record, CommandDefinition.GetDefaultDefinition());
        }

		public IEnumerable<UsdExchangeRateTableRecord> Find(IDbConnection connection, UsdExchangeRateTableRecord record)
        {
		...
		public UsdExchangeRateTableRecord Find1(IDbConnection connection, UsdExchangeRateTableRecord record, CommandDefinition definition)
        {
			return Find1Internal(connection, record, definition);
        }

		public IEnumerable<UsdExchangeRateTableRecord> Find(IDbConnection connection, UsdExchangeRateTableRecord record, CommandDefinition definition)
        {
