...
namespace Lunggo.Repository.TableRepository
{
	public class FlightSegmentTableRepo : TableDao<FlightSegmentTableRecord>, IDbTableRepository<FlightSegmentTableRecord> 
    {
		...
		public FlightSegmentTableRecord Find1(IDbConnection connection, FlightSegmentTableRecord record)
        {
            return Find1(connection, record, CommandDefinition.GetDefaultDefinition());
        }

		public IEnumerable<FlightSegmentTableRecord> Find(IDbConnection connection, FlightSegmentTableRecord record)
        {
		...
		public FlightSegmentTableRecord Find1(IDbConnection connection, FlightSegmentTableRecord record, CommandDefinition definition)
        {
			return Find1Internal(connection, record, definition);
        }

		public IEnumerable<FlightSegmentTableRecord> Find(IDbConnection connection, FlightSegmentTableRecord record, CommandDefinition definition)
        {
