...
namespace Lunggo.CustomerWeb.Models
{
    ...
    enum RequestActParam
    {
        SearchActivityType = 0,      
        Location       = 1, 
        CheckinDate    = 2, 
        CheckoutDate   = 3, 
        //AdultCount     = 4, 
    ...
    public class ActivitySearchApiRequest
    {
        ...
        public SearchActivityParameter SearchParamObject { get; set; }

        public ActivitySearchApiRequest(string query)
        {
    ...
    public class SearchActivityParameter
    {
        [JsonProperty("date")]
