// home controller
app.controller('B2BHotelSearchController', ['$scope', '$log', '$window', '$http', '$resource', '$timeout', '$interval', 'hotelSearchSvc',
function ($scope, $log, $window, $http, $resource, $timeout, $interval, hotelSearchSvc) {
    ...
    $scope.getUrlHotelDetail = function (hotel) {
        ...
        var url = '/id/b2bhotel/' + hotel.country + '/' + destinationName +
