...
function loadingOverlay(state) {
    ...
    var createLoadingOverlay = function () {
        $('body').attr('data-loadingOverlay-created','true');
        $('body').append('<div class="loading-overlay"><div id="spinner"></div><div class="text">Loading</div></div>');
    ...
    // check if loading overlay existed
    if ($('.loading-overlay').length < 1) {
        createLoadingOverlay();
    }

    // show of hide loading overlay
