...
namespace Lunggo.Generator.TableRepo
{
    class TableRepoGenerator
    {
        ...
        static void Main(string[] args)
        {
            ...
            String connectionString = @"Server=tcp:travorama-dv2.database.windows.net,1433;Database=travorama-dv2;User ID=developer@travorama-dv2;Password=Standar1234;Trusted_Connection=False;Encrypt=True;Connection Timeout=30;";
