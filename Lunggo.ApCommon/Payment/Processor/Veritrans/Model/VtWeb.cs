...
namespace Lunggo.ApCommon.Payment.Processor
{
    internal partial class PaymentProcessorService
    {
        ...
        {
            [JsonProperty("enabled_payments")] internal List<string> EnabledPayments { get; set; }

            [JsonProperty("credit_card_3d_secure")]
            internal bool CreditCard3DSecure { get; set; }

            [JsonProperty("payment_options")] internal string PaymentOptions { get; set; }
            [JsonProperty("credit_card_bins")] internal string CreditCardBins { get; set; }
