...
namespace Lunggo.ApCommon.Activity.Database.Query
{
    internal class GetAppointmentListQuery : DbQueryBase<GetAppointmentListQuery, AppointmentDetail>
    {
        ...
        {
            var clauseBuilder = new StringBuilder();
            clauseBuilder.Append("WHERE (ar.BookingStatusCd = 'CONF' OR ar.BookingStatusCd = 'TKTD' OR ar.BookingStatusCd = 'CACU' OR ar.BookingStatusCd = 'CAAD' OR ar.BookingStatusCd = 'CAOP') AND ");
