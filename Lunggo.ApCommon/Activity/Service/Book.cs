...
namespace Lunggo.ApCommon.Activity.Service
{
    public partial class ActivityService
    {
        public BookActivityOutput BookActivity(BookActivityInput input)
        {
            ...
            var rsvDetail = CreateActivityReservation(input, getDetail.ActivityDetail, dateAndSession);
        ...
        public ActivityReservation CreateActivityReservation(BookActivityInput input, ActivityDetail activityInfo, List<DateAndAvailableHour> dateAndSession)
        {
