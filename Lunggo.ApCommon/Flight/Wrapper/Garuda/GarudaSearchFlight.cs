                    ...
                    foreach (var itin in dataItins)
                    {
                        ...
                        foreach (var segment in itin.Segments)
                        {
                            ...
                            segments.Add(new FlightSegment
                            {
                                ...
                                AircraftCode = segment.Equipment.Name,
                                DepartureCity = segment.BeginLocation.CityName,
                                ArrivalCity = segment.EndLocation.CityName,
                                AirlineName = segment.Airline.Name,
                                OperatingAirlineName = segment.Airline.Name,
                                DepartureTerminal = segment.BeginTerminal,
                                ArrivalTerminal = segment.EndTerminal,
                                DepartureAirportName = segment.BeginLocation.LocationName,
                                ArrivalAirportName = segment.EndLocation.LocationName,
