            ...
            else
            {
                ...
                if (isReturn)
                {
                    ...
                    for (var itinListIdx = 0; itinListIdx < searchedItinLists.Count; itinListIdx++)
                    {
                        ...
                        SaveFlightRequestPrices(input.RequestId, input.SearchId, searchedItinList, itinListIdx);
                    }
                ...
                else 
                {
                    ...
                    AddPriceMargin(searchedItinList);
                    SaveFlightRequestPrices(input.RequestId, input.SearchId, searchedItinList);
