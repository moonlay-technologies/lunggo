...
namespace Example
{
    internal class Webapi
    {
        ...
        private Web _apiOfSendGrid = new Web("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");
        ...
        public void SimpleHTMLEmail()
        {
            ...
            Web a  = new Web(new NetworkCredential(_username, _password));
