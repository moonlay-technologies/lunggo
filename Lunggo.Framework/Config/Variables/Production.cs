    ...
    public partial class ConfigManager
    {
        private static Dictionary<string, string> PopulateDictionary()
        {
            return new Dictionary<string, string>
            {
                ...
                {"redis.searchResultCacheConnectionString","lunggomasterprod.redis.cache.windows.net:6380,allowAdmin=true,syncTimeout=5000,ssl=true,password=V3eI+jg1FctJBdenB3p1MKNvS8fT/oC/VC0/iSif8h0="},
